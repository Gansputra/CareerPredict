<section>
    <header>
        ...
        <p class="mt-1 text-sm text-slate-400">
            Lengkapi identitas profesional Anda untuk meningkatkan rekomendasi AI.
        </p>
    </header>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-8 space-y-10" enctype="multipart/form-data">
        ...
        <div class="space-y-8">
            <div class="grid grid-cols-1 gap-8">
                ...
                <div>
                    <label for="name" class="block text-sm font-bold uppercase tracking-widest text-slate-500 mb-2">Nama Lengkap</label>
                ...
                <div>
                    <label for="email" class="block text-sm font-bold uppercase tracking-widest text-slate-500 mb-2">Alamat Email</label>
                ...
                <div>
                    <label for="phone" class="block text-sm font-bold uppercase tracking-widest text-slate-500 mb-2">Nomor Telepon</label>
                ...
                <div>
                    <label for="headline" class="block text-sm font-bold uppercase tracking-widest text-slate-500 mb-2">Headline Profesional</label>
                ...
                <div>
                    <label for="bio" class="block text-sm font-bold uppercase tracking-widest text-slate-500 mb-2">Bio Singkat</label>
