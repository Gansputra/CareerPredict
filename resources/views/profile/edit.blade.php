...
<div class="max-w-4xl mx-auto space-y-8">
    ...
    <!-- Password Update -->
    <div class="glass p-6 animate-fade-in" data-aos="fade-up" data-aos-delay="100">
        <div class="w-full">
    ...
    <!-- Danger Zone -->
    <div class="glass p-6 border-l-4 border-rose-500 animate-fade-in" data-aos="fade-up" data-aos-delay="200">
        <div class="w-full">
