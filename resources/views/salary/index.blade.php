...
<div class="space-y-8">
    ...
    <div class="animate-fade-in">
        ...
        <h1 class="text-3xl font-extrabold text-white mb-1">Info <span class="text-gradient">Gaji</span></h1>
        <p class="text-slate-400 text-sm">Data gaji aktual dari {{ $overallStats['total_jobs'] }} lowongan aktif di {{ $overallStats['categories'] }} kategori.</p>
    </div>
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <div class="glass-dark p-5 animate-fade-in" style="animation-delay: 0ms">
            <div class="flex items-center gap-3 mb-3">
                ...
                <span class="text-[10px] font-bold text-slate-500 uppercase tracking-widest">Rata-rata Tertinggi</span>
            </div>
        ...
        <div class="glass-dark p-5 animate-fade-in" style="animation-delay: 60ms">
            <div class="flex items-center gap-3 mb-3">
                ...
                <span class="text-[10px] font-bold text-slate-500 uppercase tracking-widest">Rata-rata Terendah</span>
            </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-5 gap-8">
        ...
        <div class="lg:col-span-3 glass-dark p-6 lg:p-8 animate-fade-in" style="animation-delay: 200ms">
            <h3 class="text-lg font-bold text-white mb-6"><i class="fas fa-chart-bar text-blue-400 mr-2"></i> Rata-rata Gaji per Kategori</h3>
            <div class="h-80">
                ...
                <div class="flex items-center justify-between mb-3">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-[10px] text-slate-500">{{ $cat['jobs_count'] }} lowongan</p>
                        </div>
                    </div>
    ...
    <div class="animate-fade-in" style="animation-delay: 400ms">
        <h2 class="text-2xl font-bold text-white mb-2"><i class="fas fa-trophy text-amber-400 mr-2"></i> Posisi Bergaji Tertinggi</h2>
        <p class="text-slate-400 text-sm mb-6">Lowongan dengan gaji tertinggi yang saat ini tersedia.</p>
